window.skins=window.skins||{};
	...
	function EnergyFreeItemSkin() {
		_super.call(this);
		this.skinParts = ["img","lab1","lab2","btn"];
		
		this.height = 163;
		this.width = 565;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.img_i(),this.lab1_i(),this.lab2_i(),this.btn_i()];
	}
	...
	_proto.container_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 750;
		t.elementsContent = [this.bg_i(),this._Group1_i(),this._Label1_i()];
		return t;
	};
	_proto.bg_i = function () {
		var t = new eui.Image();
	...
	function PlayFinshSkin() {
		_super.call(this);
		this.skinParts = ["bg","energyNum","leftTimeLab","energyBtn","topGrp","stageGrp","stageNumGrp","wordGrp","nextBtn","returnBtn","red","shareBtn","grp"];
	...
	_proto.grp_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 750;
		t.elementsContent = [this.bg_i(),this.topGrp_i(),this.stageGrp_i(),this.stageNumGrp_i(),this._Label1_i(),this.wordGrp_i(),this.nextBtn_i(),this.returnBtn_i(),this.red_i(),this.shareBtn_i()];
		return t;
	};
	_proto.bg_i = function () {
		var t = new eui.Image();
